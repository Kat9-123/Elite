namespace Elite
{
    ...
    public static class Models
    {
        ...
        public static Mesh bigLaserMesh = Utils.GenerateRepeatingMesh(ModelHandler.LoadModel("BigLaser.obj"),1000,20);

        public static Mesh planet = ModelHandler.LoadModel("Planet.obj");
